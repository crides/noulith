...
#[test]
fn split() {
    assert_eq!(simple_eval("'1-3-5' split '-' join '+'"), Obj::from("1+3+5"));
    assert_eq!(simple_eval("'1-3-5' split '-' by 2 join '+'"), Obj::from("1+3-5"));
    assert_eq!(simple_eval("'1-3-5' rsplit '-' join '+'"), Obj::from("5+3+1"));
    assert_eq!(simple_eval("'1-3-5' rsplit '-' by 2 join '+'"), Obj::from("5+1-3"));
}
